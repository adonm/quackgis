...
METRIC_COLUMNS = [
    ...
    "osm_extract_bytes",
    "postgis_points_named_count",
    "postgis_lines_named_count",
    "postgis_multipolygons_named_count",
    "quackgis_points_named_count",
    "quackgis_lines_named_count",
    "quackgis_multipolygons_named_count",
    "postgis_points_geojson_count",
    "postgis_lines_geojson_count",
    "postgis_multipolygons_geojson_count",
    "quackgis_points_geojson_count",
    "quackgis_lines_geojson_count",
    "quackgis_multipolygons_geojson_count",
    ...
    "mvt_points_attribute_ok",
    "mvt_lines_attribute_ok",
    "mvt_multipolygons_attribute_ok",
    "postgis_passed",
    "postgis_total",
    "postgis_total_min",
    "postgis_pass_rate",
...
def render_dashboard(rows: list[dict[str, Any]]) -> str:
    ...
    body.extend(
        [
            ...
            f"| Client real-data counts | `osm_postgis_parity` | {sum(1 for row in latest if present(row, 'qgis_points_feature_count') or present(row, 'qgis_lines_feature_count') or present(row, 'qgis_multipolygons_feature_count') or present(row, 'mvt_points_tile_bytes') or present(row, 'mvt_points_attribute_ok'))} check(s) |",
