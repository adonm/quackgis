...
| PostgreSQL catalogs/RBAC | relational core catalogs, development-gated stable user-object/default/comment/NOT-NULL identity, truthfully empty index projection, bounded role-aware spatial metadata, immutable roles/sessions/grants/inquiry, and role-aware information schema | upstream identity bundle plus unavailable DuckLake primary/unique/foreign-key indexes, authoritative CRS/subtype metadata, and copied-client qualification remain open |
