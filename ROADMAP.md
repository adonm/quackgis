...
| Security | SCRAM, outer read/write table allowlists, immutable table/operation RBAC, role-filtered maintained metadata, actual-process required-TLS/restart rotation, and packaged mTLS/edge-key rotation with old-certificate denial | no RLS, mutable administration, role-aware OpenAPI, JWT/database rotation, or production revocation drill |
