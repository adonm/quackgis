...
| PostgreSQL catalogs/RBAC | relational core catalogs, development-gated stable user-object identity, immutable roles/sessions/grants/inquiry, and role-aware schema/table/column/grant information schema | upstream identity bundle plus traced constraints/indexes/defaults/comments/spatial metadata and copied-client qualification remain open |
