...
- The offline migrator requires an exact PostgreSQL/PostGIS version pin, opens one
  ...
  rollback, and final decisions without becoming a resume/promotion token. Richer
  spatial report dimensions and broader key/CRS/geometry semantics remain open.
