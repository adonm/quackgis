...
| C0 PostgreSQL compatibility | basic psql/psycopg/OGR smokes pass; client-neutral catalog fixture established; `pg18-column-core-v1` and digest-pinned PostgreSQL 18.4 result-type oracle frozen; target catalog/RBAC plan documented | capture pinned copied-data psql/OGR/QGIS traces, close durable identity feasibility, then implement relational core catalogs and role/session semantics |
