...
- The offline migrator requires an exact PostgreSQL/PostGIS version pin, opens one
  ...
  immutable target policy; credentials and role DDL remain excluded. Progress
  checkpoints, richer spatial report dimensions, and broader key/CRS/geometry
