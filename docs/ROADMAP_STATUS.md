...
- The I0 binaries load owner-only key files and validate omitted-public versus
  ...
  Actual DuckDB queries, COPY, cancellation outcomes, public/custom relay paths,
  resource budgets, packaged local-boundary protection, and role-catalog
  preauthentication remain open.
