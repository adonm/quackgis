...
- The I0 binaries load owner-only key files and validate omitted-public versus
  ...
  existing M1/M2 result/COPY memory gates. Packaged local-boundary protection and
  role-catalog preauthentication remain open.
