...
| C0 PostgreSQL compatibility | basic psql/psycopg/OGR smokes pass; client-neutral catalog fixture established; target PostgreSQL 18 catalog/RBAC plan documented | freeze the profile/query corpus, decide durable identity, then implement core catalogs and role/session semantics before copied-data client qualification |
