...
| E1 M1/M2 local profiles | active for M1 interruption policy; M2 reference closed | clean 1M/10M BIGINT, 1M wide-result, 100-cancel, eligible 50M transport, and 10M COPY references pass; mixed reader/writer/maintenance admission passes its native smoke oracle; next write/commit interruption policy and evidence |
